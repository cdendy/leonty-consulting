...
export default function AboutTeaser() {
  return (
    <section id="about-teaser" className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-12 md:py-20">
      <div className="space-y-4 md:pr-8">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800">About Erin Leonty</h2>
